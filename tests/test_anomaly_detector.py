...
class TestDataQualityChecker:
    ...
    def test_empty_dataframe(self):
        import pandas as pd
        report = DataQualityChecker().quality_report(pd.DataFrame({"x": []}))
